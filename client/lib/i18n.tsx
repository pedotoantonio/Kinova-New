...
const translations = {
  it: {
    ...
    notes: {
      ...
      emptyState: "Nessuna nota",
      noSearchResults: "Nessuna nota trovata",
      addFirst: "Crea la tua prima nota",
      searchPlaceholder: "Cerca note...",
      titlePlaceholder: "Titolo della nota...",
      contentPlaceholder: "Scrivi qui le tue note...",
      colorLabel: "Colore",
      filterAll: "Tutte",
      filterPinned: "Preferite",
      filterEvents: "Eventi",
      filterTasks: "Attività",
      filterExpenses: "Spese",
      filterShopping: "Spesa",
      relatedEvent: "Evento",
      relatedTask: "Attività",
      relatedExpense: "Spesa",
      relatedShopping: "Lista spesa",
      deleteTitle: "Elimina nota",
  ...
  en: {
    ...
    notes: {
      ...
      addFirst: "Create your first note",
